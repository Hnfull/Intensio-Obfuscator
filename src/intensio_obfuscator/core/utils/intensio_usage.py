...
class Args:
    ...
    def __init__(self):
        ...
        self.parser.add_argument(
                                "--excludewords",
                                default=False,
                                help="file to exclude specific words (check documentation for the format) only for 'replace string \
                                to string mixed' obfuscation feature"
        )
        self.parser.add_argument(
                                "-ps", "--paddingscript",
                                action="store_true",
        ...
        self.parser.add_argument(
                                "--excludefiles",
                                default=False,
                                help="file to exclude file name (check documentation for the format) only for 'replace file name' \
                                obfuscation feature"
        )
        self.parser.add_argument(
                                "-rth", "--replacetohex",
